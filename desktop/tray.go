...
func (a *App) startTray() {
	...
	t.end = startDesktopTray(func() {
		...
		systray.SetTitle("Quantara")
		systray.SetTooltip("Quantara")
...
func trayMenuLabels(locale string) trayLabels {
	if locale == "zh" {
		return trayLabels{
			openTitle:   "打开",
			openTooltip: "打开 Quantara 窗口",
			quitTitle:   "退出",
			quitTooltip: "退出 Quantara",
		}
	}
	return trayLabels{
		openTitle:   "Open",
		openTooltip: "Open the Quantara window",
		quitTitle:   "Quit",
		quitTooltip: "Quit Quantara",
	}
}
