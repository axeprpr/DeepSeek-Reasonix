...
####
## Quantara per-user NSIS installer.
##
...
##      forces the user back to %LOCALAPPDATA%\Programs\Quantara even if they had
##      moved the install to a different drive (e.g. D:\Tools\Quantara); the silent
...
!macro reasonix.writeUninstaller
    ...
    # user back to %LOCALAPPDATA%\Programs\Quantara even if they had moved
    # the install to a different drive (e.g. D:\Tools\Quantara). The auto-
