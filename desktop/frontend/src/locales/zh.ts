...
export const zh: Record<DictKey, string> = {
  ...
  "sidebar.navigation": "Quantara 导航",
  "sidebar.plugins": "插件",
  ...
  // 欢迎 / 空状态
  "welcome.title": "驱动智能制造",
  "welcome.tagline": "围绕工艺、产线、BOM、MES/ERP 与 CAD 任务直接下达指令。",
  "welcome.hintCommands": "命令",
  "welcome.hintFiles": "引用文件",
  "welcome.hintSend": "发送",
  "welcome.ex1": "把这个零件需求转成夹具设计思路和 CAD 建模步骤",
  "welcome.ex2": "根据 BOM 和交期约束给出产线排程建议",
  "welcome.ex3": "梳理 MES、ERP、WMS 之间的数据接口和同步流程",
  "welcome.ex4": "为这条装配工序生成 SOP、质检点和异常处理清单",

  // 输入框
  "composer.placeholder": "给 Quantara 发消息…  ( / 命令 · @ 文件 · ! 终端 )",
  ...
  "memory.emptySavedBody": "只保存对后续 Quantara 会话有帮助的长期背景。",
  ...
  "settings.closeBehavior.quit": "退出 Quantara",
  ...
  "settings.agentRuntimeHint": "作为全局默认；项目里的 ./quantara.toml 可覆盖。0 表示不限。",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 Quantara。",
  ...
  "settings.pageDesc.memory": "管理 Quantara 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.providerDesc.openaiCompatible": "适用于 OpenAI 官方或任意兼容 OpenAI API 协议的服务。",
  ...
  "settings.addProvider.chooseHint": "可直接添加推荐接入，或手动添加一个自定义 OpenAI-compatible 服务。",
  "settings.addProvider.officialChoice": "官方供应商",
  "settings.addProvider.officialChoiceHint": "使用 Quantara 预置的 OpenAI-compatible 接入模板。",
  ...
  "settings.addProvider.officialHint": "预设会写入默认端点和模型建议，你仍需要配置 API URL 与 API Key。",
  ...
  "settings.addProvider.official.openaiCompatibleDesc": "默认接入 OpenAI 官方地址，也支持替换为任意兼容 OpenAI API 协议的网关。",
  "settings.addProvider.confirm": "添加供应商",
  "settings.customProviderName": "自定义供应商名称",
  "settings.customProviderNamePlaceholder": "",
  "settings.providerNamePlaceholder": "供应商名称（如 openai-cn-gateway）",
  ...
  "settings.hooksPathProjectHint": "项目 hooks 保存到当前工作区的 .quantara/settings.json。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 Quantara 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 Quantara 后加载。",
  ...
  "updater.autoCheckHint": "关闭后，Quantara 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  "onboarding.title": "连接 Quantara",
  "onboarding.tagline": "请先配置 OpenAI 兼容协议的 API URL 和 API Key。密钥仅保存在本机凭据存储中。",
  ...
  "onboarding.error.emptyUrl": "请先填写 API URL。",
  "onboarding.error.url": "API URL 格式不正确。",
  "onboarding.error.empty": "请先粘贴密钥。",
  "onboarding.error.invalid": "这个 key 无法使用 —— 检查一下是否已激活、是否开通了计费。",
  "onboarding.error.network": "无法连接到配置的 API URL —— 请检查网络后重试。",
  ...
  // 崩溃兜底页
  "crash.title": "Quantara 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "performanceReport.title": "Quantara 检测到响应卡顿",
