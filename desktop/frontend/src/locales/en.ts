...
export const en = {
  ...
  "sidebar.navigation": "Quantara navigation",
  ...
  // welcome / empty state
  "welcome.title": "Drive Intelligent Manufacturing",
  "welcome.tagline": "Work directly on CAD, process planning, BOM, MES/ERP integration, and production execution tasks.",
  "welcome.hintCommands": "commands",
  "welcome.hintFiles": "reference files",
  "welcome.hintSend": "send",
  "welcome.ex1": "Turn this part requirement into a fixture concept and CAD modeling steps",
  "welcome.ex2": "Build a production scheduling recommendation from BOM and due-date constraints",
  "welcome.ex3": "Map the data flow between MES, ERP, and WMS for this line",
  "welcome.ex4": "Generate an SOP, QC checkpoints, and exception handling steps for this assembly process",

  // composer
  "composer.placeholder": "Message Quantara…  ( / commands · @ files · ! shell )",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future Quantara sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit Quantara",
  ...
  "settings.agentRuntimeHint": "Used as global defaults; ./quantara.toml can override them per project. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, Quantara can be used from chat.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files Quantara keeps referencing.",
  ...
  "settings.providerLabel.openaiCompatible": "OpenAI Compatible",
  "settings.providerDesc.openaiCompatible": "Use the OpenAI endpoint or any service compatible with the OpenAI API protocol.",
  ...
  "settings.addProvider.chooseHint": "Add the recommended preset, or configure a custom OpenAI-compatible service.",
  "settings.addProvider.officialChoice": "Official provider",
  "settings.addProvider.officialChoiceHint": "Use Quantara's built-in OpenAI-compatible provider template.",
  ...
  "settings.addProvider.officialHint": "The preset fills in a recommended endpoint and models, but you still need to configure API URL and API key.",
  ...
  "settings.addProvider.official.openaiCompatible": "OpenAI Compatible",
  "settings.addProvider.official.openaiCompatibleDesc": "Starts with the OpenAI endpoint and can be switched to any OpenAI-compatible gateway.",
  ...
  "settings.providerNamePlaceholder": "Provider name (e.g. openai-cn-gateway)",
  ...
  "settings.hooksPathProjectHint": "Project hooks are saved to .quantara/settings.json in the current workspace.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart Quantara to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a Quantara restart.",
  ...
  "updater.autoCheckHint": "When off, Quantara won't check automatically when it opens. You can still check manually here.",
  ...
  "updater.installing": "Installing — Quantara will restart…",
  ...
  "onboarding.title": "Connect Quantara",
  "onboarding.tagline": "Configure an OpenAI-compatible API URL and API key to start. Credentials are stored locally on this device.",
  ...
  "onboarding.modelLabel": "Default model",
  ...
  "onboarding.error.emptyUrl": "Please enter an API URL first.",
  "onboarding.error.url": "That API URL is invalid.",
  ...
  "onboarding.error.network": "Couldn't reach the API URL — check your network and try again.",
  ...
  // crash page
  "crash.title": "Quantara hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "Quantara noticed a responsiveness issue",
  ...
  "mock.changedFile2Path": ".quantara/project.md",
};
