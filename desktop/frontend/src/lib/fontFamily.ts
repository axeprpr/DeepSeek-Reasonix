...
const FONT_FAMILY_KEY = "quantara-font-family";
const CUSTOM_FONT_KEY = "quantara-font-family-custom";
const MONO_FONT_FAMILY_KEY = "quantara-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "quantara-mono-font-family-custom";
