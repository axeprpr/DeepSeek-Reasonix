...
const STORAGE_KEY = "quantara.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["quantara.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["quantara.workspaceTree.width"],
  composerHeight: ["quantara.composerHeight"],
  drawerWidth: ["quantara.drawer.width"],
  settingsDrawerWidth: ["quantara.settingsDrawer.width"],
};
